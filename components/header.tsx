...
export default function Header() {
	...
	return (
		<>
			<header className='sticky top-0 bg-background/70 backdrop-blur-sm z-50 bg-noise'>
			...
			{isOpen && (
				<div className='w-full px-6 py-4 fixed top-[72px] bg-background/70 backdrop-blur-sm z-50 border-b border-border bg-noise'>
					{LINKS.map((l) => (
						<Link
							key={l.title}
							href={l.link}
